...
// Trimmed from the registry copy: ReactNode/useEffect/useRef came in unused and
// this project builds with noUnusedLocals. Re-apply after any registry update.
